...
`JVM_VERSION` | `jdk-11-0-6_10` | The version string corresponding to the JVM_FILE. Used to name install directory.<br />:green_apple: You can use your own naming convention.
